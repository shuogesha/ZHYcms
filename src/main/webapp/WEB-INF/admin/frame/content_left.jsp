...
<SCRIPT type="text/javascript">
		...
		function onClick(event, treeId, treeNode, clickFlag) {
			...
			parent.rightFrame.location.href="content/v_list.do?channelId="+id+"&siteId="+treeNode.siteId;
		}		
		...
		$(document).ready(function(){
			...
			parent.rightFrame.location.href="content/v_list.do?siteId="+siteId;
...
<body>
	...
	<div class="lt_aside_nav content mCustomScrollbar">
		...
		<shuogesha:buttonURL  url="/content/v_list.do">
